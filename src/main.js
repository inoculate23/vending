...
<a href="#benefits"><button class="btn btn-primary text-l">Benefits</button></a>
<a href="#stats"><button class="btn btn-primary text-l">Statistics</button></a>
...
<footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
  ...
  <nav>
    <div class="grid grid-flow-col gap-4">
     ...
     <a href="https://www.sincitysweetsllc.com/#" width="24" height="24" class="fill-current">
     <svg class="fill-current" viewBox="0 0 24 24"width="24" height="24" aria-hidden="true">
